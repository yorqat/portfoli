...
<section class="section">
	...
	<p id="0.0">
		Wow you just made your very own, very proud web service whether it be your personal webpage or a
		convenient API you wrote for your pleasure but there's one problem, you can't receive requests
		from port 80, you know where you're supposed to get requests?
	</p>

	<p>
		ISPs already don't give you the privilege of free static IPs to use for your hosting project, to
		the extent of revoking reception on ports that matter.
	</p>

	<p>
		With this cold indifference how would you expose your epic home server to the world? That's when
		get our old friends: Wireguard and any of your favorite VPS really
	</p>
</section>
...
<section class="section" id="0.1">
	...
	<ol class="section-steps">
		<li>
			<p>After you created your Linode account go to your dashboard and create a linode instance</p>
			<img class="img" src="/bypass-isp-how-to/0.webp" alt="begin create linode" />
		</li>
		<li>
			<p>Pick a debian-based distro, you may pick Ubuntu but Debian 11 can cook</p>
			<img
				loading="lazy"
				class="img"
